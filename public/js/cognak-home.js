...
(function() {
    ...
    if (homeNav) {
        ...
        homeNav.querySelectorAll('a').forEach(function(a) {
            ...
            clone.style.cssText = "font-family:'Diatype Variable',sans-serif;font-size:15px;font-weight:400;color:rgba(255,255,255,0.6);text-decoration:none;letter-spacing:0.04em;";
